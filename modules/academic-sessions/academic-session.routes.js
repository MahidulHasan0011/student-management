...
router.patch("/:id/deactivate", rbacMiddleware("SESSION_UPDATE"), academicSessionController.deactivate);
router.patch("/:id/admission-test", rbacMiddleware("SESSION_UPDATE"), academicSessionController.toggleAdmissionTest);
